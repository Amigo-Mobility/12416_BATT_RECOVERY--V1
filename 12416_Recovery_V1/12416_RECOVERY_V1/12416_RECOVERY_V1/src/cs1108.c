...
//volatile _ulta_wa CS1108_ultaStatus = {{0xff,0xff,0xff,0xff,0xff,0xff,0x01,0xff}};
...
//            //else if(_address == ULTA_MISC_ADD){
//              else if(_address == ULTA_MISC_ADD){
//                 TRANSMIT_BYTE=  CS1108_ultaStatus.misc_data.byte;
//                 data_count = 0;
//            }
//            
